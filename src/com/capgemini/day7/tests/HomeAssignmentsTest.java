...
import com.capgemini.day7.domain.HomeAssignments;

class HomeAssignmentsTest {
	HomeAssignments allAssignments=new HomeAssignments() ;
	File assignment1=new File("C:\\devika\\assignment1.txt") ;
	File assignment2=new File("C:\\devika\\assignment2.txt") ;
	File assignment3=new File("C:\\devika\\assignment3.txt") ;
